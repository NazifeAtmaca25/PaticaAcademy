...
public class GelismisHesapMakinesi {
    ...
    static void mod(){
        ...
        Scanner scan=new Scanner(System.in);
        System.out.println("Mod alıcağınız sayıyı giriniz:");
        number= scan.nextInt();
        System.out.println("Mod kaç olsun:");
        mod=scan.nextInt();
        result=number%mod;
    ...
    static void rectangle(){
        int longSide, shortSide,area,circumference;
        Scanner scan=new Scanner(System.in);
        ...
        circumference=2*(longSide+shortSide);
